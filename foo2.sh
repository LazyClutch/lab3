cipherCommands=(aes-128-cbc               aes-128-cfb               aes-128-cfb1             
...
for command in "${cipherCommands[@]}"; do
	openssl $command -d -in secret.txt.enc -out output/$command -pass file:passwd-file
done
